...
export async function main(ns) {
  ...
  if (serverToFind) {
    ...
    ns.tprint(printPathToServer(serverMap.servers, 'CSEC') + '; backoor;')
    ns.tprint('')
    ns.tprint(`* avmnite-02h (NiteSec faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'avmnite-02h') + '; backoor;')
    ns.tprint('')
    ns.tprint(`* I.I.I.I (The Black Hand faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'I.I.I.I') + '; backoor;')
    ns.tprint('')
    ns.tprint(`* run4theh111z (Bitrunners faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'run4theh111z') + '; backoor;')
    ns.tprint('')
